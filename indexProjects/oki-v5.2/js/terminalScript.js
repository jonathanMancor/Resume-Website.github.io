...
function terminalKeyExecute() {
  ...
  }else if(terminalKeys[13] && terminalPage == 'playerLocker'){
    accessTerminal('repo');
  }else if(terminalKeys[13] && terminalPage == 'playerBed'){
    accessTerminal('statistics');
  }
...
function closeTerminal(cR,x,y){
  ...
  $('#bunkerGovernment').css('display', 'none');
